    ...
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title"
                id="myModalLabel"><img src="themes/SafetyNET-Beta/resources/modalicon.png" alt="" height="36" width="36"> <?php echo Yii::t('SpaceModule.views_create_modules', 'Add <strong>Modules</strong>') ?></h4>
        </div>
