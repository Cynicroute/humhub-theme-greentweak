        ...
        <div class="modal-header">
            ...
            <?php if (Yii::$app->request->get('id') != null) : ?>
                <h4 class="modal-title"
                    id="myModalLabel"><img src="themes/SafetyNET-Beta/resources/modalicon.png" alt="" height="36" width="36"> <?php echo Yii::t('TasksModule.views_task_edit', '<strong>Edit</strong> task'); ?></h4>
                <?php else : ?>
                <h4 class="modal-title"
                    id="myModalLabel"><img src="themes/SafetyNET-Beta/resources/modalicon.png" alt="" height="36" width="36"> <?php echo Yii::t('TasksModule.views_task_edit', '<strong>Create</strong> new task'); ?></h4>
                <?php endif; ?>
        </div>
