...
<div class="panel panel-default panel-profile">
    ...
    <div class="panel-profile-header">
        ...
        <div class="image-upload-container profile-user-photo-container visible-xs" style="width: 140px; height: 140px;">

            <?php if ($space->profileImage->hasImage()) : ?>
                <!-- profile image output-->
                <a data-ui-gallery="spaceHeader" href="<?= $space->profileImage->getUrl('_org'); ?>">
                       <?php echo \humhub\modules\space\widgets\Image::widget(['space' => $space, 'width' => 100]); ?>
                </a>
            <?php else : ?>
                <?php echo \humhub\modules\space\widgets\Image::widget(['space' => $space, 'width' => 100]); ?>
            <?php endif; ?>
        ...
        <div class="panel-profile-controls">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="controls controls-header pull-right hidden-xs">
                        <?php
                    ...
                    <div class="controls controls-header pull-right visible-xs btn-xs">
                        <?php
                        echo humhub\modules\space\widgets\HeaderControls::widget(['widgets' => [
                                [\humhub\modules\space\widgets\InviteButton::className(), ['space' => $space], ['sortOrder' => 10]],
                                [\humhub\modules\space\widgets\MembershipButton::className(), ['space' => $space], ['sortOrder' => 20]],
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"
                    id="myModalLabel"><img src="themes/SafetyNET-Beta/resources/modalicon.png" alt="" height="36" width="36"> <?php echo Yii::t('SpaceModule.widgets_views_profileHeader', '<strong>Something</strong> went wrong'); ?></h4>
            </div>
