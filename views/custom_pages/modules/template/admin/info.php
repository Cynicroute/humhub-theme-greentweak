    ...
    <div class="modal-content media">
        <?php $form = ActiveForm::begin(['enableClientValidation' => false]);?>
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><img src="themes/SafetyNET-Beta/resources/modalicon.png" alt="" height="36" width="36"> 
            ...
            <div class="modal-body media-body">
                <div class="info-content">
                    <?= Yii::t('CustomPagesModule.modules_template_views_admin_info', ''
                            ...
                            . 'These additions can be inserted adding for example {{ content.default }} to your template.', ['twigLink' => '<strong><a href="http://twig.sensiolabs.org/">Twig</a></strong>']); ?>
                    <br /><br />
