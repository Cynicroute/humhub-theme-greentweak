    ...
    <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title"
              id="myModalLabel">
                  <img src="themes/SafetyNET/resources/modalicon.png" width="36" height="36" alt=""/> <?php echo Yii::t('TourModule.views_tour_welcome', 'Hi <strong>%firstname%</strong>, thank you for using SafetyNET.', ['%firstname%' => $user->profile->firstname]); ?>
          </h4>
        </div>
        <div class="modal-body">
            <div class="text-center">
                <?php echo Yii::t('TourModule.views_tour_welcome', 'You are the first user here... Welcome! Be a shining example and complete your profile,<br>so that future know who they can turn to if they have questions.'); ?>
                <br><br>
                <br>
            </div>
