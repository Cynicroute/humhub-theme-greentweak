        ...
        spacesTour.addSteps([
            {
                orphan: true,
                backdrop: true,
                title: <?php echo json_encode(Yii::t('TourModule.widgets_views_guide_spaces', '<i class="fa fa-th-large"></i> <strong>Spaces</strong>')); ?>,
                content: <?php echo json_encode(Yii::t('TourModule.widgets_views_guide_spaces', "Once you have joined a new space you can work on projects, discuss topics or just share information with other users.<br><br>Admins may make available various tools to add functionality to a space, thereby making the work process more productive.")); ?>
            },
            {
                element: ".layout-nav-container .panel",
                title: <?php echo json_encode(Yii::t('TourModule.widgets_views_guide_spaces', '<i class="fa fa-th-large"></i> <strong>Space</strong> navigation menu')); ?>,
                content: <?php echo json_encode(Yii::t('TourModule.widgets_views_guide_spaces', 'This is where you can navigate the space. Active modules for the particular space you are currently in will be displayed in the "Space Menu". These could be polls, tasks or notes for example.<br><br>Only the space admin can manage the space\'s modules.')); ?>,
                placement: "right"
            },
            {
                element: ".dropdown-navigation",
                title: <?php echo json_encode(Yii::t('TourModule.widgets_views_guide_spaces', '<i class="fa fa-gear"></i> <strong>Space</strong> preferences')); ?>,
            ...
            },
            {
                ...
                title: <?php echo json_encode(Yii::t('TourModule.widgets_views_guide_spaces', '<i class="fa fa-pencil-square-o"></i> <strong>Writing</strong> posts')); ?>,
            ...
            },
            {
                ...
                title: <?php echo json_encode(Yii::t('TourModule.widgets_views_guide_spaces', '<i class="fa fa-list"></i> <strong>Posts</strong>')); ?>,
                content: <?php echo json_encode(Yii::t('TourModule.widgets_views_guide_spaces', 'Yours, and other users\' posts will appear here.<br><br>Posts can be \'liked\', commented on, or shared on social media.')); ?>,
                placement: "bottom"
            },
            {
                element: ".panel-activities",
                title: <?php echo json_encode(Yii::t('TourModule.widgets_views_guide_spaces', '<i class="fa fa-calendar"></i> <strong>Most recent</strong> activities')); ?>,
            ...
            },
            {
                ...
                title: <?php echo json_encode(Yii::t('TourModule.widgets_views_guide_spaces', '<i class="fa fa-users"></i> <strong>Space</strong> members')); ?>,
            ...
            },
            {
                orphan: true,
                backdrop: true,
                title: <?php echo json_encode(Yii::t('TourModule.widgets_views_guide_spaces', '<i class="fa fa-check-square-o"></i> <strong>This section is complete.</strong>')); ?>,
