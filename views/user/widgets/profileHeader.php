    ...
    <div class="panel-profile-header">
        ...
        <div class="image-upload-container" style="width: 100%; height: 100%; overflow:hidden;">
            ...
            <div class="img-profile-data hidden-xs">
                <h1 class="user"><?php echo Html::encode($user->displayName); ?></h1>
                <h2 class="user"><?php echo Html::encode($user->profile->title); ?></h2>
            </div>

            <div class="img-profile-data visible-xs">
                <h1 class="user"><?php echo Html::encode($user->displayName); ?></h1>
            </div>
        ...
        <div class="image-upload-container profile-user-photo-container hidden-xs" style="width: 140px; height: 140px;">
        ...
        <div class="image-upload-container profile-user-photo-container visible-xs" style="width: 100px; height: 100px;">

            <?php if ($user->profileImage->hasImage()) : ?>
                <a data-ui-gallery="profileHeader"  href="<?= $user->profileImage->getUrl('_org'); ?>">
                    <img class="img-rounded profile-user-photo" id="user-profile-image"
                         src="<?php echo $user->getProfileImage()->getUrl(); ?>"
                         data-src="holder.js/140x140" alt="140x140" style="width: 100px; height: 100px;"/>
                </a>
            <?php else : ?>
                <img class="img-rounded profile-user-photo" id="user-profile-image"
                     src="<?php echo $user->getProfileImage()->getUrl(); ?>"
        ...
        <div class="panel-profile-controls">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="controls controls-header pull-right btn-xs">
                        <?php
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"
                    id="myModalLabel"><img src="themes/SafetyNET-Beta/resources/modalicon.png" alt="" height="36" width="36"> <?php echo Yii::t('UserModule.widgets_views_profileHeader', '<strong>Something</strong> went wrong'); ?></h4>
            </div>
