            ...
            <li>
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        <span class="title" style="color:green"><?php echo Yii::t('SpaceModule.widgets_views_profileHeader', 'Members'); ?></span>:
                        <span class="count"><?php echo $space->getMemberships()->count(); ?></span>

                        <span class="title" style="color:green"><?php echo Yii::t('SpaceModule.widgets_views_profileHeader', 'Followers'); ?></span>:
                        <span class="count"><?php echo $space->getFollowerCount(); ?></span>
