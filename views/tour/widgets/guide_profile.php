...
<script type="text/javascript">
    ...
    $(document).on('ready', function () {
        ...
        orphan: true,
                backdrop: true,
                title: <?php echo json_encode(Yii::t('TourModule.widgets_views_guide_profile', '<i class="fa fa-user-circle-o"></i> <strong>User profile</strong>')); ?>,
        ...
        element: "#user-profile-image",
                title: <?php echo json_encode(Yii::t('TourModule.widgets_views_guide_profile', '<i class="fa fa-address-card-o"></i> <strong>Profile</strong> photo')); ?>,
                content: <?php echo json_encode(Yii::t('TourModule.widgets_views_guide_profile', 'Upload a new profile photo by simply clicking here or by drag & drop. You can do the same to update your cover photo.')); ?>,
                placement: "right"
        },
        {
        element: ".edit-account",
                title: <?php echo json_encode(Yii::t('TourModule.widgets_views_guide_profile', '<i class="fa fa-gears"></i> <strong>Edit</strong> account')); ?>,
        ...
        element: ".layout-nav-container .panel",
                title: <?php echo json_encode(Yii::t('TourModule.widgets_views_guide_profile', '<i class="fa fa-user-circle-o"></i> <strong>Profile</strong> menu')); ?>,
                content: <?php echo json_encode(Yii::t('TourModule.widgets_views_guide_profile', 'Just like in Spaces, the user profile can be personalized with various modules.<br><br>You can see which modules are available for your profile by looking them in “Modules” in the account settings menu.')); ?>,
                placement: "right"
        },
        {
        element: "#contentFormBody",
                title: <?php echo json_encode(Yii::t('TourModule.widgets_views_guide_profile', '<i class="fa fa-comments-o"></i> <strong>Profile</strong> stream')); ?>,
...
<?php if (Yii::$app->user->isAdmin() == true) : ?>
            ...
            orphan: true,
                    backdrop: true,
                    title: <?php echo json_encode(Yii::t('TourModule.widgets_views_guide_profile', '<i class="fa fa-check-square-o"></i> <strong>This section is complete.</strong>')); ?>,
                    content: <?php echo json_encode(Yii::t('TourModule.widgets_views_guide_profile', 'You have completed the user profile guide!<br><br>To carry on with the administration guide, click here:<br /><br />')); ?> + "<a href='javascript:gotoAdministration = true; tourCompleted();'><?php echo Yii::t("TourModule.widgets_views_guide_profile", "<strong>Administration (Modules)</strong>"); ?></a><br><br>"
            }
<?php else : ?>
            {
            orphan: true,
                    backdrop: true,
                    title: <?php echo json_encode(Yii::t('TourModule.widgets_views_guide_profile', '<i class="fa fa-check-square-o"></i> <strong>This section is complete.</strong>')); ?>,
                    content: <?php echo json_encode(Yii::t('TourModule.widgets_views_guide_profile', "You have completed the user profile guide!")); ?>
            }
<?php endif; ?>
